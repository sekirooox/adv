...
# 读取section_names
# def load_section_names(filepath):
#     with open(filepath, 'r') as f:
#         section_names = f.read().splitlines()
#     return section_names
#
# if __name__ == '__main__':
#     # 这里是对一个原始二进制文件处理
#     binary_filepath = r'C:\Users\ASUS\PycharmProjects\pythonProject\adv_mlw_examples_generation_with_gans-main\raw\BODMAS\example\00dbb9e1c09dbdafb360f3163ba5a3de_0'
#     string_feature_filepath = r'C:\Users\ASUS\PycharmProjects\pythonProject\adv_mlw_examples_generation_with_gans-main\npz\BODMAS\strings_features\malicious_target\00dbb9e1c09dbdafb360f3163ba5a3de_0.npz'
#     output_filepath = r'C:\Users\ASUS\PycharmProjects\pythonProject\adv_mlw_examples_generation_with_gans-main\raw\BODMAS\malicious_string\example_modified'
#     section_names_filepath = r'C:\Users\ASUS\PycharmProjects\pythonProject\adv_mlw_examples_generation_with_gans-main\src\section_names.txt'
#
#     pe_modifier = PEModifier(binary_filepath)
#
#     # 加载区段名称
#     COMMON_SECTION_NAMES = load_section_names(section_names_filepath)
#
#     # 加载特征向量
#     feature_vector = np.load(string_feature_filepath)['generated_features'].flatten()
#     print(feature_vector.shape)
#
#     # 特征向量转换为可注入内容
#     section_content = feature_vector.astype(np.uint8).tolist()
#
#     # 随机选择一个区段名称
#     selected_section_name = random.choice(COMMON_SECTION_NAMES)[:7]
#     print(f"Selected section name: {selected_section_name}")
#
#     # 创建并注入新的区段
#     pe_modifier.create_new_section(section_content, selected_section_name)
#
#     # 保存修改后的二进制文件
