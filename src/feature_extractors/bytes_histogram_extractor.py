...
from src.feature_extractors.feature_type import  FeatureType
...
if __name__ == "__main__":
    ...
    parser.add_argument("--executable_filepath",
                        ...
                        default=r'C:\Users\ASUS\PycharmProjects\pythonProject\adv_mlw_examples_generation_with_gans-main\data\BODMAS\bodmas.npz',
                        )
