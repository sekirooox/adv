...
if __name__ == "__main__":
    ...
    parser.add_argument("--training_filepath",
                        ...
                        default="./data/iat_features/2017/training/")# /mnt/hdd2/inception/imports/2017/training/
    parser.add_argument("--testing_filepath",
                        type=str,
                        help="Filepath to the testing features",
                        default="./data/iat_features/2017/testing/")# /mnt/hdd2/inception/imports/2017/testing/
    ...
    parser.add_argument("--output_filepath",
                        ...
                        default="models/imports_model_2017")
    ...
    for epoch in tqdm(range(training_parameters["num_epochs"])) :
