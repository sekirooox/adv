...
training_ember_2017_filepath = "../../lightgbm_models/byte_histogram_detector/train_features_0_2017.csv"
training_ember_2018_filepath = "../../lightgbm_models/byte_histogram_detector/train_features_0_2018.csv"

parameters = load_json("network_parameters/byte_histogram_net_params.json")
model = ByteHistogramNetwork(parameters)
model.load_state_dict(torch.load("models/best/best_model.pt"))# models/byte_histogram_model_2017/best/best_model.pt
model.eval()
