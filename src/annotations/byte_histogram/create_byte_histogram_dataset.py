...
if __name__ == "__main__":
    ...
    parser.add_argument("--executables_filepath",
                        ...
                        default="../../../raw/BODMAS/malicious_augmented/")# ../../../raw/BODMAS/malicious/ 虽然是恶意软件，但是保存在的是良性软件的文件夹，我把原文件夹改为了benign
    parser.add_argument("--histogram_filepath",
                        type=str,
                        help="Filepath where the histogram features will be stored in .npz format",
                        default="../../../npz/BODMAS/histogram_features/BODMAS_augmented/")# ../../../npz/BODMAS/histogram_features/benign/
    parser.add_argument("--ember_v1_filepath",
                        type=str,
                        help="Filepath where the ember features (v1) will be stored in .npz format",
                        default="../../../npz/BODMAS/ember_features/2017/BODMAS_augmented/")# ../../../npz/BODMAS/ember_features/2017/benign/
    parser.add_argument("--ember_v2_filepath",
                        type=str,
                        help="Filepath where the ember features (v2) will be stored in .npz format",
                        default="../../../npz/BODMAS/ember_features/2018/BODMAS_augmented/")# ../../../npz/BODMAS/ember_features/2018/benign/

    parser.add_argument("--raw_npz_filepath",
                        type=str,
                        help="Filepath where the bytez will be stored in .npz format",
                        default="../../../npz/BODMAS/raw_npz/BODMAS_augmented/")# ../../../npz/BODMAS/raw_npz/benign/

    parser.add_argument("--annotations_filepath",
                        type=str,
                        help="Filepath where the annotations will be stored",
                        default="data/BODMAS_malicious_augmented.csv")# data/BODMAS_benign.csv
    ...
    for i, filename in enumerate(filenames):
        try:
            ...
            savez_compressed(os.path.join(args.histogram_filepath, '{}.npz'.format(filename)),
                             histogram_array)
            savez_compressed(os.path.join(args.raw_npz_filepath,'{}.npz'.format(filename)), bytez_int_array)# 注意这里不要注释掉！
