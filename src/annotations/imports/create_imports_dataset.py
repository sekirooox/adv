...
if __name__ == "__main__":
    ...
    parser.add_argument("--vocabulary_mapping_filepath",
                        ...
                        default="../../feature_extractors/imports_vocabulary/baseline/vocabulary/vocabulary_mapping_test.json")#
    parser.add_argument("--inverse_vocabulary_mapping_filepath",
                        type=str,
                        help="Inverse vocabulary mapping",
                        default="../../feature_extractors/imports_vocabulary/baseline/vocabulary/inverse_vocabulary_mapping_test.json")
