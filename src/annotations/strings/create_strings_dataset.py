...
import src.feature_extractors.utils # 认为加入

"""
这个脚本分别对恶意软件和良性软件进行调用：
注意将它们以8：1：1的比例分为train，test，vd
"""
if __name__ == "__main__":
    ...
    parser.add_argument("--strings_filepath",
                        ...
                        default="../../../npz/BODMAS/strings_features/malicious/")
    ...
    parser.add_argument("--ember_v1_filepath",
                        ...
                        default="../../../npz/BODMAS/ember_features/2017/malicious/")  # "../../../npz/BODMAS/ember_features/2017/malicious/"

    parser.add_argument("--ember_v2_filepath",
                        type=str,
                        help="Filepath where the ember features (v2) will be stored in .npz format",
                        default="../../../npz/BODMAS/ember_features/2018/malicious/")  # "../../../npz/BODMAS/ember_features/2018/malicious/"
    parser.add_argument("--raw_npz_filepath",
                        type=str,
                        help="Filepath where the bytez will be stored in .npz format",
                        default="../../../npz/BODMAS/raw_npz/malicious/") # "../../../npz/BODMAS/raw_npz/malicious/"

    parser.add_argument("--vocabulary_mapping_filepath",
                        type=str,
                        help="Vocabulary mapping",
                        default="../../feature_extractors/strings_vocabulary/vocabulary/vocabulary_mapping_top20000_test.json")# 需要更换为你自己的json
    parser.add_argument("--inverse_vocabulary_mapping_filepath",
                        type=str,
                        help="Inverse vocabulary mapping",
                        default="../../feature_extractors/strings_vocabulary/vocabulary/inverse_vocabulary_mapping_top20000_test.json")# 需要更换你自己的json文件

    parser.add_argument("--annotations_filepath",
                        type=str,
                        help="Filepath where the annotations will be stored",
                        default="data/BODMAS_malicious.csv")
    ...
    for i, filename in enumerate(filenames):
        try:
            ...
            src.feature_extractors.utils.save_all_strings(
