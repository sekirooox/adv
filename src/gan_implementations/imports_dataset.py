...
if __name__ == "__main__":
    ...
    parser.add_argument("--imports_features_filepath",
                        ...
                        default='../../npz/BODMAS/imports_features/baseline/malicious'
                        )
    ...
    parser.add_argument("--annotations_filepath",
                        ...
                        default='../../src/annotations/all_features/data/BODMAS_malicious_train_None.csv'#csv
                        )
    parser.add_argument('--sample_idxs', type=int, help="Indices",default=1)#default=1 #nargs="+", 避免传入列表
    args = parser.parse_args()

    pe_dataset = ImportsDataset(# PEImports->Imports
    ...
    for (d_features, d_hashed_features, d_paths, d_ember_features_version1, d_ember_features_version2, d_raw_paths, d_y) in dataloader:
        print("Import features: ", d_features.shape)
        print("Hashed import features: ", d_hashed_features.shape)
        print("Imports dict: ", d_paths)
        print("EMBER features (Version 1): ", d_ember_features_version1.shape)
        print("EMBER features (Version 2): ", d_ember_features_version2.shape)
        print("Label: ", d_y)
