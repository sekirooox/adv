...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="../../../../npz/BODMAS/strings_features/malicious/"# ../../../npz/BODMAS/strings_features/20000/malicious/
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        default="../../../../npz/BODMAS/raw/malicious/"# /home/dgl3/Datasets/BODMAS/malicious/
    )
    """训练和验证集"""
    parser.add_argument(
        ...
        default="../../../annotations/all_features/data/BODMAS_malicious_train_None.csv")
    parser.add_argument(
        "--validation_malware_annotations_filepath",
        type=str,
        help="Filepath to malicious annotations (validation)",
        default="../../../annotations/all_features/data/BODMAS_malicious_validation_None.csv")
    ...
    parser.add_argument(
        ...
        default="../../../../npz/BODMAS/strings_features/benign/"# ../../../../npz/BODMAS/strings_features/benign/
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        default="../../../../npz/BODMAS/raw/benign/"# /home/dgl3/Datasets/BODMAS/benign/
    )
    """训练和测试"""
    parser.add_argument(
        ...
        default="../../../annotations/all_features/data/BODMAS_benign_train_None.csv"
    )
    parser.add_argument(
        "--validation_goodware_annotations_filepath",
        type=str,
        help="Filepath to benign annotations (validation)",
        default="../../../annotations/all_features/data/BODMAS_benign_validation_None.csv"
    )
    """词汇表"""
    parser.add_argument(
        ...
        default="../../../feature_extractors/strings_vocabulary/vocabulary/vocabulary_mapping_top20000_test.json")

    parser.add_argument(
        "--inverse_vocabulary_mapping_filepath",
        type=str,
        help="Inverse vocabulary mapping filepath",
        default="../../../feature_extractors/strings_vocabulary/vocabulary/inverse_vocabulary_mapping_top20000_test.json"
    )
    parser.add_argument(
        "--output_filepath",
        type=str,
