...
def predict_and_save_features(generator_model_path, sample_data_path, output_directory):
    ...
    for sample_file in sample_files:
        ...
        # 准备噪声向量
        z_size = 128  # 修改噪声的大小，这个取决于超参数json文件
